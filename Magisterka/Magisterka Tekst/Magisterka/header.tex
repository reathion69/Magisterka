...
%ABSTRACT
\begin{abstract}
Niniejsza praca opisuje proces przystosowania algorytmu przeszukiwania z Tabu do rozwiązywania problemu układania planu zajęć. Aspektem badawczym pracy było zbadanie wpływu parametrów zaimplementowanego algorytmu na szybkość jego działania i otrzymane wyniki. Omówione zostały teoretyczne zagadnienia pracy oraz problemy towarzyszące implementacji. Testowanie algorytmu zostało przeprowadzone na danych rzeczywistych, a wyniki zaprezentowane na wykresach.
\end{abstract}
%END OF ABSTRACT
